...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202302251357-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Feb 25, 2023 13:57 EST
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/tor"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="tor"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/tor"
APPDIR="$HOME/.local/share/srv/docker/tor"
DATADIR="$HOME/.local/share/srv/docker/tor/rootfs"
...
TOR_USERNAME="${TOR_USERNAME:-$DEFAULT_USERNAME}"
TOR_PASSWORD="${TOR_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default tor
CONTAINER_HOSTNAME="${CONTAINER_HOSTNAME:-$APPNAME}"
CONTAINER_DOMAINNAME="${CONTAINER_DOMAINNAME:-$HOSTNAME}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# URL to container image [docker pull URL]
HUB_IMAGE_URL="casjaysdevdocker/tor"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
CONTAINER_HTTP_PORT="15000:80"
CONTAINER_HTTPS_PORT=""
CONTAINER_SERVICE_PORT=""
CONTAINER_ADD_CUSTOM_PORT="9053,9050,9080"
...
CONTAINER_USER_NAME="${TOR_USERNAME:-}"
CONTAINER_USER_PASS="${TOR_PASSWORD:-}"
...
SET_USER_NAME="${CONTAINER_USER_NAME:-$TOR_USERNAME}"
SET_USER_PASS="${CONTAINER_USER_PASS:-$TOR_PASSWORD}"
